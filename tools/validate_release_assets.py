...
REPO_NAME = "cfnet-change-detection-pipeline"
NOTEBOOK_NAME = "cfnet_change_detection_colab.ipynb"
EXPECTED_PROFILE = "E2E"
EXPECTED_MODEL_ID = "wifibk/CFNet"
...
# The dataset-mirror revision and the vendored upstream commit are cited beside the model pin.
KNOWN_SHAS: frozenset[str] = frozenset(
    {"ba68aa9a54ae15fe32ce9b02c380eb384fae528e", "54acadab23b9d9395ec6814386c2d4a1253eac5a"}
)
BYOD_GATES = ("USE_BYOD",)
EXPECTED_OUTPUTS = (
    "outputs/cfnet_change_detection_sample_before.png",
    "outputs/cfnet_change_detection_sample_after.png",
    "outputs/cfnet_change_detection_sample_label.png",
    "outputs/cfnet_change_detection_sample_pairs.csv",
    "outputs/cfnet_change_detection_evaluation_report.json",
    "outputs/cfnet_change_detection_predictions.json",
    "outputs/cfnet_change_detection_adapter",
    "outputs/cfnet_change_detection_result.json",
)
CODE_MARKERS = (
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    3_419_684: "adapter.safetensors from save_artifact (default config, Kaggle run 2026-09-19)",
    15_598_980: "converted cfnet-levir-cd.safetensors (regenerated, not staged)",
    16_921_921: "total of the 192 pinned PNG members of LEVIR-CD-processed.tar.gz",
    3_831_872_824: "LEVIR-CD-processed.tar.gz, dataset wifibk/CFNet_Datasets@ba68aa9",
}
EXTERNAL_WEIGHT_DIGESTS: dict[str, str] = {
    "5b9f0ba08490293d6c17b9cef219991e1a6edda31609429679f8dca1af5a7b10": "pickle-audit digest of levir-cd.pth globals",
    "6515dd451c159b9ed5bd53b3fb6e15188dd114b296ff9169ca21fbcabcd1d109": "LEVIR-CD-processed.tar.gz, dataset wifibk/CFNet_Datasets@ba68aa9",
    "b348186e5003a7447ab5eb5874204c50e63ad71aa61aca3ff0a80746116963d9": "converted cfnet-levir-cd.safetensors (regenerated)",
}
